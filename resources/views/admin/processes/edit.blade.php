...
@section('content')
    ...
    {!! Form::model($process, ['method' => 'PUT', 'route' => ['admin.processes.update', $process->id]]) !!}
        ...
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    {!! Form::checkbox('compliant_rohs', 1, old('compliant_rohs', old('compliant_rohs')), []) !!}
                    <p class="help-block"></p>
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    {!! Form::checkbox('compliant_reach', 1, old('compliant_reach', old('compliant_reach')), []) !!}
                    <p class="help-block"></p>
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('archive', trans('global.processes.fields.archive').'', ['class' => 'control-label']) !!}
