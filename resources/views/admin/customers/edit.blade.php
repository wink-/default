...
@section('content')
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('contact1', trans('global.customer.fields.contact1').'', ['class' => 'control-label']) !!}
                    {!! Form::text('contact1', old('contact1'), ['class' => 'form-control', 'placeholder' => '']) !!}
                    <p class="help-block"></p>
                    @if($errors->has('contact1'))
                        <p class="help-block">
                            {{ $errors->first('contact1') }}
                        </p>
                    @endif
                </div>
            </div>
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('extension1', trans('global.customer.fields.extension1').'', ['class' => 'control-label']) !!}
                    {!! Form::text('extension1', old('extension1'), ['class' => 'form-control', 'placeholder' => '']) !!}
                    <p class="help-block"></p>
                    @if($errors->has('extension1'))
                        <p class="help-block">
                            {{ $errors->first('extension1') }}
                        </p>
                    @endif
                </div>
            </div>
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('contact2', trans('global.customer.fields.contact2').'', ['class' => 'control-label']) !!}
                    {!! Form::text('contact2', old('contact2'), ['class' => 'form-control', 'placeholder' => '']) !!}
                    <p class="help-block"></p>
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('phone2', trans('global.customer.fields.phone2').'', ['class' => 'control-label']) !!}
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('extension2', trans('global.customer.fields.extension2').'', ['class' => 'control-label']) !!}
                    {!! Form::text('extension2', old('extension2'), ['class' => 'form-control', 'placeholder' => '']) !!}
                    <p class="help-block"></p>
                    @if($errors->has('extension2'))
                        <p class="help-block">
                            {{ $errors->first('extension2') }}
                        </p>
                    @endif
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('tax_id', trans('global.customer.fields.tax-id').'', ['class' => 'control-label']) !!}
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('cod', trans('global.customer.fields.cod').'', ['class' => 'control-label']) !!}
                    {!! Form::hidden('cod', 0) !!}
                    {!! Form::checkbox('cod', 1, old('cod', old('cod')), []) !!}
                    <p class="help-block"></p>
                    @if($errors->has('cod'))
                        <p class="help-block">
                            {{ $errors->first('cod') }}
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('archive', trans('global.customer.fields.archive').'', ['class' => 'control-label']) !!}
