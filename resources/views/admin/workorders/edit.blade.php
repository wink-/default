...
@section('content')
    ...
    {!! Form::model($workorder, ['method' => 'PUT', 'route' => ['admin.workorders.update', $workorder->id]]) !!}
        ...
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    {!! Form::checkbox('rework', 1, old('rework', old('rework')), []) !!}
                    <p class="help-block"></p>
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    {!! Form::hidden('hot', 0) !!}
                    {!! Form::checkbox('hot', 1, old('hot', old('hot')), []) !!}
                    <p class="help-block"></p>
                    @if($errors->has('hot'))
                        <p class="help-block">
                            {{ $errors->first('hot') }}
